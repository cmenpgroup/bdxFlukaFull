...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::Results*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("Results", ::Results::Class_Version(), "Results.h", 6,
                  typeid(::Results), ::ROOT::Internal::DefineBehavior(ptr, ptr),
   ...
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::Results*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));
...
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::Results*)0x0)->GetClass(); }
   return fgIsA;
}
...
"/usr/local/include",
"/home/russ2/Fluka/bdxFlukaFull/",
0
    };
    static const char* fwdDeclCode = R"DICTFWDDCLS(
#line 1 "ResultsDict dictionary forward declarations' payload"
...
#line 1 "ResultsDict dictionary payload"
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("ResultsDict",
        ...
        TriggerDictionaryInitialization_ResultsDict_Impl, {}, classesHeaders, /*has no C++ module*/false);
      isInitialized = true;
    }
  }
